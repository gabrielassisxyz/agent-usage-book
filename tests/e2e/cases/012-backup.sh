...
case_assertions() {
    ...
    # The archive is verified the moment it is created: schema version 23 is
    ...
    assert_stdout_contains 2 "schema=23 generation="
    ...
    assert_stdout_contains 3 "schema=23 generation="
