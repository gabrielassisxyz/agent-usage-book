...
case_assertions() {
    ...
    # The archive is verified the moment it is created: schema version 35 is
    ...
    assert_stdout_contains 2 "schema=35 generation="
    ...
    assert_stdout_contains 3 "schema=35 generation="
