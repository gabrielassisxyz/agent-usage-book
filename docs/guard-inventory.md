...
sh-01	aub-vcx.4	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/01-presentation-no-provider-adapters			FAIL: rule01-flat exits 1	printf 'use crate::calibration;\n' >> src/transcripts.rs; bin/checks/boundary-rules/02-transcripts-no-calibration	nonzero	02-transcripts-no-calibration
sh-02	aub-vcx.4	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/02-transcripts-no-calibration			FAIL: rule02-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-03	aub-vcx.4	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/03-meter-no-sqlite			FAIL: rule03-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-04	aub-vcx.4	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/04-cost-model-no-config			FAIL: rule04-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-05	aub-vcx.4	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/05-advice-no-calibration			FAIL: rule05-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-06	aub-vcx.4	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/06-status-no-http-transport			FAIL: rule06-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-07	aub-vcx.4	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/07-provider-adapters-no-credential-paths			FAIL: rule07-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-08	aub-vcx.4,aub-rif.10	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/08-window-selection-ownership			FAIL: rule08 exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-09	aub-vcx.4,aub-xus.1	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/09-presentation-no-store-or-calibration			FAIL: rule09-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-10	aub-vcx.4,aub-me5.2	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/10-freshness-constructed-only-in-domain			FAIL: rule10 exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-11	aub-vcx.4,aub-sth.3	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/11-store-connections-through-one-function			FAIL: rule11 exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-12	aub-vcx.4,aub-eun.2	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/12-transport-no-ureq-outside-transport			FAIL: rule12 exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-13	aub-vcx.4,aub-lqe.3	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/14-parser-no-cost-or-meter			FAIL: rule14-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-14	aub-vcx.4,aub-sth.4	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/15-status-no-migration			FAIL: rule15-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-15	aub-6gco	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/18-no-system-clock-outside-time			FAIL: rule18-flat exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-16	aub-me5.7	shell	bin/boundary-rules-selftest	neuter	bin/checks/boundary-rules/19-status-no-store-connection			FAIL: rule19-status exits 1	printf 'use crate::meter;\n' >> src/presentation.rs; bin/checks/boundary-rules/01-presentation-no-provider-adapters	nonzero	01-presentation-no-provider-adapters
sh-17	aub-eun.2	shell	bin/checks/boundary-rules/13-no-async-runtime-dependency	sed	Cargo.toml	/^\[dependencies\]$/a tokio = "1.99.0"		Forbidden async runtime detected	bin/checks/70-quantity-inventory	0	every pub struct/enum
...
c-01	aub-vcx.5,aub-71j.1,aub-rif.12,aub-rif.2,aub-eun.1	cargo	cargo test --test compile_fail compile_fail	write	tests/compile_fail/domain_quantities_no_default.rs	fn main() {}		fail to compile, but it succeeded	cargo test --test compile_fail every_fixture_has_captured_output	0	test result: ok
